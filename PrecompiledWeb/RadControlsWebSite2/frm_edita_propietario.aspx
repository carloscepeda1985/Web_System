<%@ page language="VB" masterpagefile="~/Site.Master" enableeventvalidation="false" autoeventwireup="false" inherits="frm_edita_propietario, App_Web_s02ude0q" title="YouSoft" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
...
<div style="height: 41px">
 <asp:Button ID="Button3" runat="server" Text="Eliminar Propietario" CssClass ="btn btn-success" style="float:right;" />
</div>
