<%@ page language="VB" masterpagefile="~/Site_residente.Master" enableeventvalidation="false" autoeventwireup="false" inherits="frm_familia, App_Web_s02ude0q" title="YouSoft" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
...
.btn-sample .badge {
 color: #FFFFFF;
  ...
  border-color: #3BBFA5;
   ...
   <div class="col-md-9">
    <div class="bar"><e class="letracolor">Familiares</e></div>
    <div container>
     <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal" style="float:right;">Agregar Familiar</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Ingrese datos de su Familiar</h4>
        </div>
        <div class="modal-body">
          <p>
          <asp:Label ID="Label1" runat="server" Text="Rut:"></asp:Label><asp:TextBox ID="TextBox1" runat="server" CssClass="form-control"></asp:TextBox> 
          ...
          Parentesco:<asp:TextBox ID="TextBox4" runat="server" CssClass="form-control"></asp:TextBox> 
          </p>
        </div>
...
<br />
    ...
    <div class="table-responsive">
        <asp:GridView ID="GridView1" runat="server" Width="100%" 
            ...
            <HeaderStyle BackColor="#2C777A" ForeColor="White" />
        </asp:GridView>
 </div>
