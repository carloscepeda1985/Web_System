<%@ page language="VB" masterpagefile="~/Site_residente.Master" enableeventvalidation="false" autoeventwireup="false" inherits="frm_editar_familiar, App_Web_s02ude0q" title="YouSoft" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
...
<!-- Form Name -->
<legend>Editar Familiar</legend>

<!-- Text input-->
<div style="height: 41px">
 <asp:Button ID="Button3" runat="server" Text="Eliminar Familiar" CssClass ="btn btn-success" style="float:right;" />
</div>
