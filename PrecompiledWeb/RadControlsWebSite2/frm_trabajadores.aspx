<%@ page language="VB" masterpagefile="~/Site_residente.Master" enableeventvalidation="false" autoeventwireup="false" inherits="frm_trabajadores, App_Web_s02ude0q" title="YouSoft" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
...
height:38px;
background-image: -webkit-linear-gradient(top,#ff8029 0,#ff8029 0%);
background-image: linear-gradient(to bottom,#ff8029 0,#ff8029 0%);
font-size:40px;
...
.btn-sample .badge {
 color: #FFFFFF;
  ...
  border-color: #3BBFA5;
   ...
   <div class="col-md-9">
    <div class="bar"><e class="letracolor">Trabajadores</e></div>
    <div container>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          Función:<asp:TextBox ID="TextBox4" runat="server" CssClass="form-control"></asp:TextBox> 
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" 
         ...
         <Columns>
                <asp:CommandField ButtonType="Button" ShowSelectButton="True" 
                    SelectImageUrl="~/editar.png" ControlStyle-CssClass="btn btn-warning" SelectText="Editar" />
            </Columns>
            <HeaderStyle BackColor="#FF8029" ForeColor="White" />
        </asp:GridView>
