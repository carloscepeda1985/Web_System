<%@ page language="VB" masterpagefile="~/Site.Master" enableeventvalidation="false" autoeventwireup="false" inherits="frm_editar_tags, App_Web_s02ude0q" title="YouSoft" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
...
<!-- Form Name -->
<legend>Editar Tag</legend>

<!-- Text input-->
<div style="height: 41px">
 <asp:Button ID="Button3" runat="server" Text="Eliminar Tag" CssClass ="btn btn-success" style="float:right;" />
</div>

<div class="form-group">
  <label class="col-md-4 control-label">N° Tag</label>  
...
<div class="form-group">
  <label class="col-md-4 control-label" >Patente</label> 
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
