<%@ page language="VB" masterpagefile="~/Site.Master" enableeventvalidation="false" autoeventwireup="false" inherits="frm_trabajadorescond, App_Web_s02ude0q" title="YouSoft" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div>
        ...
        <asp:TextBox ID="numero" runat="server" Font-Size="Medium" Width="100px"></asp:TextBox>
         Nombre :
        <asp:TextBox ID="TextBox4" runat="server" Font-Size="Medium" Width="120px"></asp:TextBox>
         Apellido :
        <asp:TextBox ID="TextBox6" runat="server" Font-Size="Medium" Width="120px"></asp:TextBox>
         Empresa :
        <asp:TextBox ID="TextBox7" runat="server" Font-Size="Medium" Width="120px"></asp:TextBox>

        <asp:Button ID="Button2" runat="server" Font-Size="Small" Text="Buscar" 
            CssClass="btn btn-warning" Font-Bold="True" />
  <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal" style="float:right;">Agregar Trabajador</button>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          Telefono:<asp:TextBox ID="TextBox10" runat="server" CssClass="form-control"></asp:TextBox> <br/>
          Función:<asp:TextBox ID="TextBox5" runat="server" CssClass="form-control"></asp:TextBox> <br/>
          Empresa:<asp:TextBox ID="TextBox9" runat="server" CssClass="form-control"></asp:TextBox> <br/>
          </p>
        </div>
    ...
    <br />
     ...
     <div class="clear hideSkiplink">
        <center><asp:Label ID="Label1" runat="server" Text="Registro Trabajadores" Font-Bold="True" 
